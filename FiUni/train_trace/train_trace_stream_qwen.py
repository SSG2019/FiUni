...
from fiunilib.train_strategy import LSTrainOrchestrator, build_ls_stream
...
def run(args):
    ...
    for i, name in enumerate(task_names):
        ...
        ga = task_grad_accs[i]
        task_tokenized = build_causal_lm_dataset(td.train, tokenizer, args.max_source_len, args.max_target_len)
    ...
    visualize(
        ...
        task_names,
        total_batches,
        out_dir / "trace_train_timeline.svg",
        grad_accum_steps=1,
    )
